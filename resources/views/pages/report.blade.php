        ...
        <div class="card">
          <div class="card-body">
                          ...
                          <td class="px-0">
                              @foreach ($dailyReport as $report)
                                  <div class="d-flex align-items-center">
                                      <div class="ms-2 text-truncate-title d-flex align-items-center">
            ...
            <div class="text-end mt-2">
                <button type="button" class="btn btn-primary " data-bs-toggle="modal" data-bs-target="#confirmLogtimeModal">
                    Create Report
                  </button>
              </div>
          </div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="mb-3">
                ...
                <input type="date" class="form-control" id="spent_on" name="spent_on" value="{{ date('Y-m-d') }}" required>
            </div>
            <div class="mb-3">
...
<!-- Confirm modal -->
<div class="modal fade" id="confirmLogtimeModal" tabindex="-1" aria-labelledby="confirmLogtimeModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
